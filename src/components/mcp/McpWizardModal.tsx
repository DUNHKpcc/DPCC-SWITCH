              ...
              <>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full resize-y rounded-md border border-border-default bg-background px-3 py-2 text-sm font-mono text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-black/15 dark:focus:ring-white/20"
                  />
                </div>
