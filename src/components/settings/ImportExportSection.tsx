      ...
      <div className="space-y-4 rounded-lg border border-border bg-muted/40 p-6">
        ...
        <div className="grid grid-cols-2 gap-4 items-stretch">
          ...
          <div className="relative">
            <Button
              type="button"
              className={`h-auto w-full px-4 py-3 ${selectedFile && !isImporting ? "flex-col items-start" : "items-center"}`}
          ...
          <div>
            <Button
              type="button"
              className="h-full w-full px-4 py-3 items-center"
              onClick={onExport}
            >
...
function ImportStatusMessage({
  ...
  if (status === "importing") {
    return (
      <div
        className={`${baseClass} border-border-default bg-muted/70 text-foreground`}
      >
