...
/// 将 `/path/to/DPCC-SWITCH.app/Contents/MacOS/DPCC-SWITCH` 转换为 `/path/to/DPCC-SWITCH.app`
#[cfg(target_os = "macos")]
...
mod tests {
    ...
    fn test_get_macos_app_bundle_path_valid() {
        let exe_path = std::path::Path::new("/Applications/DPCC-SWITCH.app/Contents/MacOS/DPCC-SWITCH");
        let result = get_macos_app_bundle_path(exe_path);
        assert_eq!(
            result,
            Some(std::path::PathBuf::from("/Applications/DPCC-SWITCH.app"))
        );
    }
    ...
    fn test_get_macos_app_bundle_path_with_spaces() {
        let exe_path =
            std::path::Path::new("/Users/test/My Apps/DPCC-SWITCH.app/Contents/MacOS/DPCC-SWITCH");
        let result = get_macos_app_bundle_path(exe_path);
        assert_eq!(
            result,
            Some(std::path::PathBuf::from(
                "/Users/test/My Apps/DPCC-SWITCH.app"
            ))
        );
    }
